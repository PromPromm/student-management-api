...
Revision ID: a40c4bb53e1e
Revises: 
Create Date: 2023-03-08 01:58:00.331131
...
def upgrade():
    ...
    sa.Column('enrollment_status', sa.Enum('ACTIVE', 'WAITLIST', 'EXPELLED', name='enrollmentstatus'), nullable=False),
